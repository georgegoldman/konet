import 'package:curnect/src/presignup/services/business_hours.dart';
...
class _BusinessHoursState extends State<BusinessHours> {
  ...
  BusinessHourService? _businessHourService;

  @override
  void initState() {
    _businessHourService = BusinessHourService(context: context);
    super.initState();
  }
            ...
            child: ElevatedButton(
              ...
              onPressed: days['sunday']!['on'] ||
                  ...
                  ? () async {
                      setState(() {
                        _businessHour =
                            _businessHourService?.businessHourRequest(days);
                      });
                      _businessHour;
